...
public class CreateFooCommentCommandValidator : AbstractValidator<CreateFooCommentCommand>
{
    public CreateFooCommentCommandValidator(IFooValidator fooValidator)
    {
