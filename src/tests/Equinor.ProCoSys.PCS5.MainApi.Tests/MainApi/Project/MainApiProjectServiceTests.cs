...
namespace Equinor.ProCoSys.PCS5.ForeignApi.Tests.MainApi.Project
{
    [TestClass]
    public class MainApiProjectServiceTests
    {
        ...
        private readonly string _project1Name = "NameA";
        private readonly string _project1Description = "Description1";
