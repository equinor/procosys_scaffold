...
using Equinor.ProCoSys.PCS5.WebApi.IntegrationTests.Invitations;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using DisciplineType = Equinor.ProCoSys.PCS5.WebApi.IntegrationTests.Invitations.DisciplineType;
