...
using Equinor.ProCoSys.PCS5.ForeignApi.MainApi.CommPkg;
using Equinor.ProCoSys.PCS5.ForeignApi.MainApi.McPkg;
using Equinor.ProCoSys.PCS5.ForeignApi.MainApi.Me;
...
using IMainPersonApiService = Equinor.ProCoSys.PCS5.ForeignApi.MainApi.Person.IPersonApiService;
